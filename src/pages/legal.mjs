 ...
 * document, and they say so at the top. Open Cut has no company, no registered address and no
...
export function privacyPage() {
  return wrapper(
    'Privacy',
    'Privacy',
    'A plain description of what Open Cut does with your data. It is short because the answer is mostly “nothing”.',
    `<h2>The application</h2>
     <p><strong>Open Cut runs entirely on your computer.</strong> Your projects, your media and your exports
     ...
     <p>Open Cut stores preferences, your recent-projects list, autosave snapshots and caches in its own
     ...
     <p>If Open Cut ever gains a feature that sends data anywhere — an optional AI service being the obvious
     ...
     <h2>Questions</h2>
     <p>Open Cut is an independent project with no published contact channel yet. When there is one, it will
       be listed on the <a href="/help/">Help</a> page.</p>`,
    '/privacy/',
    'Open Cut runs entirely on your computer. No account, no analytics, no tracking, and no media ever leaves your machine.'
  );
}
...
export function termsPage() {
  return wrapper(
    'Terms',
    'Terms',
    'Open Cut is free software released under the ' +
      esc(site.license) +
      ' licence. This page explains what that means in practice; the licence itself is the actual legal text.',
    `<h2>The licence</h2>
     <p>Open Cut is released under the <strong>${esc(site.license)} licence</strong>. In practice that means
     ...
     <p>Open Cut claims no rights over anything you make with it. Your projects, your media and your exports
     ...
     <p>As the ${esc(site.license)} licence states, the software is provided “as is”, without warranty of
       any kind. Open Cut ${esc(version)} is an early version with known issues, listed in full on the
     ...
     <p>Practical advice rather than legal language: keep backups of source media you cannot replace, and
       save your projects. Open Cut autosaves and can recover a session after a crash, but no editor should
     ...
     <p><strong>Every editing feature is free and is intended to remain free</strong> — video editing, photo
       ...
       them.</p>
     <p>Open Cut has no AI features today. If AI-powered features are introduced in future, they may be
     ...
     <p>Open Cut can use <strong>FFmpeg</strong> for media import, thumbnails and video export. FFmpeg is a
       separate project with its own licence, and it is not included in the current build — you install it
       yourself. Open Cut is also built on Electron, Chromium and Node.js, each under its own licence.</p>

     <h2>Changes</h2>
     <p>This page describes Open Cut ${esc(version)}. If the terms change, the change will be described in
       the release notes for the version it takes effect in.</p>`,
    '/terms/',
    `Open Cut is free software under the ${site.license} licence. Use it for anything, including commercial work. Your projects and exports are yours.`
  );
}
